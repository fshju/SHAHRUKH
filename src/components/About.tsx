  ...
  return (
    <section id={id} className="flex items-center justify-center min-h-screen">
      <div className="container mx-auto px-6">
        <h2
          className="text-3xl font-bold text-purple-400 text-center mt-4"
          data-aos="fade-up"
        >
          About Me
        </h2>
        <p
          className="mt-2 text-sm text-primary text-center md:mb-3"
          data-aos="fade-up"
        >
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start mt-8">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h1 className="text-primary text-4xl font-bold" data-aos="fade-up">
              Hello, I&apos;m{" "}
              <span className="text-purple-500">Shahrukh Ishtiaq</span>
            </h1>
            <p
              ...
              data-aos-delay="200"
            >
              I am a dedicated and passionate Front-End Developer with a strong
              foundation in Computer Networking and Telecommunications. With a
              keen eye for design and functionality, I strive to create
              engaging, intuitive, and responsive digital experiences.
            </p>
            ...
            <div
              ...
              data-aos-delay="400"
            >
              <button className="px-6 py-2 hover:border-black bg-purple-600 hover:bg-purple-700 rounded-lg">
                Download CV
              </button>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 text-center">
          ...
          <div
            className="p-6 bg-[#1b0039] rounded-lg"
            data-aos="flip-left"
            data-aos-delay="200"
          >
