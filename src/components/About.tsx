...
const AboutMe = ({ id }: { id: string }) => {
  ...
  const handleOpenCV = () => {
    const fileUrl = "https://drive.google.com/file/d/1fM3jqaaC1_TLzHd-YAxAoAzS16_APnSl/view?usp=drivesdk"; // CV ka URL ya path
    window.open(fileUrl, "_blank"); // New tab me open karega
  };
